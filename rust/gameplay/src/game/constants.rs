...
pub const ENEMY_MASS: f32 = 1.0;
pub const ENEMY_LINEAR_DAMPING: f32 = 10.0;
pub const ENEMY_DRIVE_FORCE: f32 = ENEMY_SPEED * ENEMY_LINEAR_DAMPING; // ≈ 25
pub const PLAYER_LINEAR_DAMPING: f32 = 0.0;
