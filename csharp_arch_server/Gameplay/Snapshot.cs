...
public sealed class Snapshot
{
    ...
    public readonly List<PlayerSnap> Players = new(Constants.MaxPlayers);
    public readonly List<EnemySnap> Enemies = new(1024);
    public readonly List<FireEvent> RecentFireEvents = new(16);
